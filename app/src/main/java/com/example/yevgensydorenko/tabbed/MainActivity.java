...
import static com.example.yevgensydorenko.tabbed.R.id.container;
...
//        }
    ...
    public void firstRun()
    {
        if(getUser("First run")==0)
        {
            ...
            String [][] str15= {{"date","2019-04-26"},{"time","10"},{"temperature","25"}};
            String [][] str16= {{"date","2019-04-27"},{"time","20"},{"temperature","26"}};
            String [][] str17= {{"date","2019-04-28"},{"time","30"},{"temperature","24"}};
            String [][] str18= {{"date","2019-04-29"},{"time","40"},{"temperature","23"}};
            String [][] str19= {{"date","2019-04-30"},{"time","50"},{"temperature","27"}};
            String [][] str20= {{"date","2019-05-01"},{"time","10"},{"temperature","25"}};
            String [][] str21= {{"date","2019-05-02"},{"time","20"},{"temperature","26"}};
            String [][] str22= {{"date","2019-05-03"},{"time","30"},{"temperature","24"}};
            String [][] str23= {{"date","2019-05-04"},{"time","40"},{"temperature","23"}};
